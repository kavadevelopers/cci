                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php if(get_user()['user_type'] == 0 && $value['status'] == 1){ ?>
                                    <button class="btn btn-primary btn-mini edit-payment" data-company="<?= $value['company'] ?>" data-id="<?= $value['id'] ?>" data-client="<?= $value['client'] ?>" data-date="<?= vd($value['date']) ?>" data-amount="<?= $value['amount'] ?>" data-remarks="<?= $value['remarks'] ?>" data-pay_type="<?= $value['pay_type'] ?>" data-pay_remarks="<?= $value['pay_remarks'] ?>" title="Edit">
